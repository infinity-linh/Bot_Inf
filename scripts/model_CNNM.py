...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        self.fc1 = nn.Linear(in_features=246016, out_features=600)
...
# image1 = cv2.resize(image1, [255,255]).transpose([2,0,1])/255
# image2 = cv2.resize(image2, [255,255]).transpose([2,0,1])/255
